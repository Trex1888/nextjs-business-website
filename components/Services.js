  ...
  return (
    <div className="border relative border-white max-w-6xl mx-auto mt-12 mb-20 lg:mt-28">
      ...
      >
        ...
        <h2
          className="absolute top-36 right-8 mt-16 pl-2 text-white 
        ...
        <h2
          className="absolute top-1/2 right-9 mt-11 text-white  
        ...
        <h2
          className="absolute bottom-14 pl-2 mt-9 text-white 
        ...
        <h2
          className="absolute right-20 bottom-14 pl-4 mt-9 text-white

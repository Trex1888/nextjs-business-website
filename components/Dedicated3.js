  ...
  return (
    ...
    >
      ...
      >
        ...
        move us forward on our digital strategy. Besides delivering top notch
        software, they demonstrated an{" "}
        <span className="blue">engineering mindset and practices</span> that
        helped immensely push our culture forward on our journey."
      </h2>
      <p
